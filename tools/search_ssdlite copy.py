...
def parse_args():
    # CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 ./tools/search_ssdlite_b64.py
    ...
    parser.add_argument('--port', type=int, default=7070, help='random seed')
    parser.add_argument(
        '--launcher',
...
def main():
    ...
    if args.work_dir is not None:
        if args.job_name is '':
            ...
            args.job_name = osp.join('output_default', args.model + '_adapt_b' + str(batch_size))
