...
def parse_args():
    # CUDA_VISIBLE_DEVICES=2,3,4,5 python -m torch.distributed.launch --nproc_per_node=4 ./tools/search_yolof.py
    # CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 ./tools/search_yolof.py \
    # --job_name yolof_1280_sub_obj_0.1_adapt \
    # --resume_from output/yolof_1280_adapt/epoch_8.pth

    parser = argparse.ArgumentParser(description='Train a detector')
    # Retinanet
    parser.add_argument('--model', default='yolof', help='model name') # temp
    parser.add_argument('--config', default='./configs/fna_yolof_search.py', help='train config file path')
